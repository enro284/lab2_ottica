...
#define BKG 0.
#define I_0 3.5
#define LAMBDA 600.E-9
#define D 0.00005876666667
#define X_0 0.058
...
void myfunc(double bkg = BKG, double I0 = I_0, double lambda = LAMBDA, double d = D, double x0 = X_0, double L = LUNGHEZZA)
{
...
void myfit(TString fname = " ", double bkg = BKG, double I0 = I_0, double lambda = LAMBDA, double d = D, double x0 = X_0, double L = LUNGHEZZA)
{
   TGraphErrors *data = new TGraphErrors(fname, "%lg %lg %lg");
